...
(function (e, t, n, r) {
    ...
    Foundation.libs.dropdown = {
        ...
        version: "5.4.5",
        settings: {
            active_class: "open", mega_class: "mega", align: "bottom", is_hover: !1, opened: function () {
            }, closed: function () {
            }
        },
        init: function (e, t, n) {
        ...
        css: function (e, t) {
            var n = Math.max((t.width() - e.width()) / 2, 8), r = t.data(this.attr_name(!0) + "-init") || this.settings;
            this.clear_idx();
            if (this.small()) {
        ...
        dirs: {
            _base: function (e) {
                ...
                var n = Foundation.libs.dropdown, r = n.dirs._base.call(this, e);
        ...
        adjust_pip: function (e, t, n, r) {
            var i = Foundation.stylesheet, s = 8;
            e.hasClass(n.mega_class) ? s = r.left + t.outerWidth() / 2 - 8 : this.small() && (s += r.left - 8), this.rule_idx = i.cssRules.length;
            var o = ".f-dropdown.open:before", u = ".f-dropdown.open:after", a = "left: " + s + "px;", f = "left: " + (s - 1) + "px;";
    ...
    Foundation.libs.offcanvas = {
        ...
        events: function () {
            ...
            this.settings.open_method === "move" ? (r = "move-", i = "right", s = "left") : this.settings.open_method === "overlap_single" ? (r = "offcanvas-overlap-", i = "right", s = "left") : this.settings.open_method === "overlap" && (r = "offcanvas-overlap"), n(this.scope).off(".offcanvas").on("click.fndtn.offcanvas", ".left-off-canvas-toggle", function (s) {
                ...
                var o = t.get_settings(s), u = n(this).parent();
                ...
                var o = t.get_settings(i), u = n(this).parent();
    ...
    Foundation.libs.alert = {
        name: "alert", version: "5.4.5", settings: {
            callback: function () {
            }
        }, init: function (e, t, n) {
            this.bindings(t, n)
    ...
    Foundation.libs.reveal = {
        ...
        open: function (n, r) {
            ...
            if (!s.hasClass("open")) {
                ...
                typeof s.data("css-top") == "undefined" && s.data("css-top", parseInt(s.css("top"), 10)).data("offset", this.cache_offset(s)), this.key_up_on(s), s.trigger("open").trigger("open.fndtn.reveal"), u.length < 1 && this.toggle_bg(s, !0), typeof r == "string" && (r = {url: r});
                if (typeof r == "undefined" || !r.url)u.length > 0 && this.hide(u, o.css.close), this.show(s, o.css.open); else {
        ...
        resize: function () {
            ...
            for (var n in t)if (t.hasOwnProperty(n)) {
                ...
                r && this.settings.directives[r.scenario[1]].call(this, r.el, r.scenario[0], function () {
                    if (arguments[0]instanceof Array)var e = arguments
                        [0]; else var e = Array.prototype.slice.call(arguments, 0);
    ...
    "use strict";
    Foundation.libs.tab = {
        name: "tab", version: "5.4.5", settings: {
            ...
            var e = this, n = this.S, r = function (t) {
            ...
            n(this.scope).off(".tab").on("focus.fndtn.tab", "[" + this.attr_name() + "] > * > a", r).on("click.fndtn.tab", "[" + this.attr_name() + "] > * > a", r).on("mouseenter.fndtn.tab", "[" + this.attr_name() + "] > * > a", function (t) {
                var r = n(this).closest("[" + e.attr_name() + "]").data(e.attr_name(!0) + "-init");
            ...
            var o = this.S, u = i.closest("[" + this.attr_name() + "]"), a = i.find("a"), f = i.children("a").first(), l = "#" + f.attr("href").split("#")[1], c = o(l), h = i.siblings(), p = u.data(this.attr_name(!0) + "-init"), d = function (t) {
                var r = e(this), i = e(this).parents("li").prev().children('[role="tab"]'), s = e(this).parents("li").next().children('[role="tab"]'), o;
                switch (t.keyCode) {
                    case 37:
                        o = i;
                        break;
                ...
                o.length && (r.attr({tabindex: "-1", "aria-selected": null}), o.attr({
                    tabindex: "0",
                    "aria-selected": !0
    ...
    Foundation.libs.abide = {
        ...
        check_validation_and_apply_styles: function (t) {
            ...
            while (n--) {
                var o = t[n][0], u = t[n][2], a = o.value.trim(), f = this.S(o).parent(), l = o.getAttribute(this.add_namespace("data-abide-validator")), c = o.type === "radio", h = o.type === "checkbox", p = this.S('label[for="' + o.getAttribute("id") + '"]'), d = u ? o.value.length > 0 : !0, v = [], m, g;
                ...
                if (c && u)v.push(this.valid_radio(o, u)); else if (h && u)v.push(this.valid_checkbox(o, u)); else {
                    t[n][1].test(a) && d || !u && o.value.length < 1 || e(o).attr("disabled") ? v.push(!0) : v.push(!1), v = [v.every(function (e) {
                        return e
                    })];
                    if (v[0])this.S(o).removeAttr(this.invalid_attr), o.setAttribute("aria-invalid", "false"), o.removeAttribute("aria-describedby"), m.removeClass("error"), p.length > 0 && this.settings.error_labels && p.removeClass("error").removeAttr("role"), e(o).triggerHandler("valid"); else {
                        this.S(o).attr(this.invalid_attr, ""), o.setAttribute("aria-invalid", "true");
                        var y = m.find("small.error, span.error"), b = y.length > 0 ? y[0].id : "";
